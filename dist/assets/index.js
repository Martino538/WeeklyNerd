...
window.addEventListener("scroll", function() {
  ...
  if (scrollPosition > 0) {
    header2.style.backgroundColor = "#0E1122";
  } else if (header2.classList.contains("menu-open")) {
...
gsapWithCSS.to(".search-card", {
  opacity: 1,
  duration: 1,
  stagger: 0.1
  // dit zorgt ervoor dat elke kaart 0.5 seconden na de vorige infade
});
